...
def create_basic_pdf(
    ...
    for page_num in range(pages):
        ...
        if add_image:
            ...
            c.drawImage(ImageReader(img_buffer), 100, y_position - 100, width=50, height=50)
...
def create_large_pdf(target_size_kb: float = 600) -> bytes:
    ...
    large_text = "This is a very long text that will be repeated many times to make the PDF large. " * 5000
